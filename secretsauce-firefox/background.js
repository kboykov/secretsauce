// SecretSauce - Background Script (Firefox MV2)
// Author: K. Boykov
...
// Firefox MV2: use browserAction instead of action
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (message.type === 'UPDATE_BADGE') {
    ...
    // Firefox MV2: setBadgeTextColor is not supported, omit it
    chrome.browserAction.setBadgeText({ text, tabId });
    chrome.browserAction.setBadgeBackgroundColor({ color: '#e53e3e', tabId });
    return false;
  }
